...
$statement = $pdo->prepare("SELECT logo,favicon FROM tbl_settings WHERE id=1");
$statement->execute();
...
<body class="hold-transition fixed skin-blue sidebar-mini">
	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="index.php" class="logo" style="background:white; padding:6px;">
				<img class="logo-lg" src="../img/logo/Manral logo 1.png"></span>
			</a>
					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="assets/images/theme/admin.png" class="user-image" alt="User Image">
								<span class="hidden-xs"><?php echo $_SESSION['user']['email']; ?></span>
							</a>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<!--             <li class="treeview <?php if (($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') || ($cur_page == 'low-category.php') || ($cur_page == 'low-category-add.php') || ($cur_page == 'low-category-edit.php')) {
																echo 'active';
															} ?>">-->
					<!--                 <a href="#">-->
					...
					<!--                 </ul>-->
					<!--             </li>-->
					<!--             <li class="treeview <?php if (($cur_page == 'size.php') || ($cur_page == 'collection.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'collection-add.php') || ($cur_page == 'size-add.php') || ($cur_page == 'collection-edit.php') || ($cur_page == 'color.php') || ($cur_page == 'color-edit.php') || ($cur_page == 'color-add.php')) {
																echo 'active';
															} ?>">-->
					<!--                 <a href="#">-->
					<!--                     <i class="fa fa-cogs"></i>-->
					...
					<!--      <a href="slider.php">-->
					<!--        <i class="fa fa-picture-o"></i> <span>AboutUs</span>-->
					<!--      </a>-->
					<!--</li>-->
					<li class="treeview <?php if (($cur_page == 'photo.php')) {
											echo 'active';
										} ?>">
						<a href="photo.php">
							<i class="fa fa-picture-o"></i> <span>Manage Gallery</span>
						</a>
					</li>

					<li class="treeview <?php if (($cur_page == 'banners.php')) {
											echo 'active';
										} ?>">
						<a href="banners.php">
					...
					<li class="treeview <?php if (($cur_page == 'page.php')) {
						...
						<a href="service.php">
							<i class="fa fa-tasks"></i> <span>Manage Service</span>
						</a>
					</li>
					<li class="treeview <?php if (($cur_page == 'blog.php')) {
						...
						<!--<a href="faq.php">-->
						<!--  <i class="fa fa-question-circle"></i> <span>Testimonial</span>-->
						<!--</a>-->
						<!--</li>-->
			         ...
			         <a href="customer.php">
			           <i class="fa fa-user-plus"></i> <span>Registered Customer</span>
						...
						<!--<li class="treeview <?php if (($cur_page == 'customer-review.php')) {
													echo 'active';
												} ?>">-->
					...
					<li class="treeview <?php if (($cur_page == 'meta_tag.php')) {
											echo 'active';
										} ?>">
						<a href="meta_tag.php">
