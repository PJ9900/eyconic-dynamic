					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						...
						<tbody>
							...
							?>
								<tr>
									<td><?php echo $i; ?></td>
									<td style="width:130px;"><img src="assets/images/services-image/<?php echo $row['photo']; ?>" alt="<?php echo $row['title']; ?>" style="width:120px;"></td>
									<td><?php echo $row['name']; ?></td>
									<td><?php echo $row['slug']; ?></td>
									<td><?php echo $row['s_long_description']; ?></td>
									<td>
										<?php if ($row['s_is_active'] == 1) {
									...
									<td><?php echo $row['s_short_description']; ?></td>
									<td>
