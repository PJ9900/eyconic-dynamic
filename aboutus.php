      ...
      <div class="col-lg-6 mt--25">
        ...
        <div class="about-right-content-area-solar-energy">
          <div class="title-area-left">
            ...
            Welcome To Iconic Solar
            </h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore quibusdam nostrum tenetur odit? Minus
              vel mollitia esse tenetur nesciunt molestias consequatur, quia fuga, earum ratione dicta placeat culpa,
              eveniet repudiandae?</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis quidem et hic alias tempora perferendis,
              non beatae, aliquam veritatis doloribus culpa sapiente soluta? Dicta pariatur praesentium deleniti ullam
              odio voluptate.</p>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="title-area-center title-g">
          <p class="pre skew-up">Our <span> Services </span></p>
          <h2 class="title skew-up">Why Choose Iconic Solar?</h2>
        </div>
      </div>
    </div>
          ...
          <div class="icon">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill="white" />
              <path
                d="M33 40C32.736 40 32.48 39.894 32.292 39.708L28.292 35.708C27.902 35.318 27.902 34.684 28.292 34.294C28.682 33.904 29.316 33.904 29.706 34.294L32.95 37.538L39.246 30.342C39.61 29.924 40.242 29.884 40.658 30.248C41.074 30.612 41.116 31.242 40.752 31.658L33.752 39.658C33.57 39.866 33.308 39.99 33.032 40C33.022 40 33.01 40 33 40Z"
                fill="white" />
              <path
                d="M19 42H5C2.244 42 0 39.758 0 37V11C0 8.242 2.244 6 5 6H9C9.552 6 10 6.448 10 7C10 7.552 9.552 8 9 8H5C3.346 8 2 9.346 2 11V37C2 38.654 3.346 40 5 40H19C19.552 40 20 40.448 20 41C20 41.552 19.552 42 19 42Z"
                fill="white" />
              <path
                d="M33 18C32.448 18 32 17.552 32 17V11C32 9.346 30.654 8 29 8H25C24.448 8 24 7.552 24 7C24 6.448 24.448 6 25 6H29C31.756 6 34 8.242 34 11V17C34 17.552 33.552 18 33 18Z"
                fill="white" />
              <path
                d="M23 12H11C9.346 12 8 10.654 8 9V5C8 4.448 8.448 4 9 4H12.1C12.566 1.72 14.584 0 17 0C19.416 0 21.434 1.72 21.9 4H25C25.552 4 26 4.448 26 5V9C26 10.654 24.654 12 23 12ZM10 6V9C10 9.55 10.448 10 11 10H23C23.552 10 24 9.55 24 9V6H21C20.448 6 20 5.552 20 5C20 3.346 18.654 2 17 2C15.346 2 14 3.346 14 5C14 5.552 13.552 6 13 6H10Z"
                fill="white" />
              <path
                d="M27 18H7C6.448 18 6 17.552 6 17C6 16.448 6.448 16 7 16H27C27.552 16 28 16.448 28 17C28 17.552 27.552 18 27 18Z"
                fill="white" />
              <path
                d="M21 24H7C6.448 24 6 23.552 6 23C6 22.448 6.448 22 7 22H21C21.552 22 22 22.448 22 23C22 23.552 21.552 24 21 24Z"
                fill="white" />
              <path
                d="M17 30H7C6.448 30 6 29.552 6 29C6 28.448 6.448 28 7 28H17C17.552 28 18 28.448 18 29C18 29.552 17.552 30 17 30Z"
                fill="white" />
            </svg>
          </div>
          <div class="content">
            ...
            <p class="disc">
              Our team of experienced professionals is dedicated to delivering exceptional service.
            </p>
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mt--70">
        ...
        <div class="rts-single-working-process">
          ...
          <div class="content">
            ...
            <p class="disc">
              We use high-quality solar panels and inverters from leading brands.
            </p>
            <div class="step_number">
              <span>02</span>
            </div>
          ...
          <div class="icon">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                ...
                fill="#FD8F14" />
              <path
                d="M46.125 12C47.1593 12 48 11.1585 48 10.125C48 9.0915 47.1593 8.25 46.125 8.25C45.0908 8.25 44.25 9.0915 44.25 10.125C44.25 11.1585 45.0908 12 46.125 12ZM46.125 9.75C46.3313 9.75 46.5 9.918 46.5 10.125C46.5 10.332 46.3313 10.5 46.125 10.5C45.9188 10.5 45.75 10.332 45.75 10.125C45.75 9.918 45.9188 9.75 46.125 9.75Z"
                fill="#FD8F14" />
              <path
                d="M40.8751 3.75C41.9093 3.75 42.75 2.9085 42.75 1.875C42.75 0.8415 41.9093 0 40.8751 0C39.8408 0 39.0001 0.8415 39.0001 1.875C39.0001 2.9085 39.8408 3.75 40.8751 3.75ZM40.8751 1.5C41.0813 1.5 41.2501 1.668 41.2501 1.875C41.2501 2.082 41.0813 2.25 40.8751 2.25C40.6688 2.25 40.5001 2.082 40.5001 1.875C40.5001 1.668 40.6688 1.5 40.8751 1.5Z"
                fill="#FD8F14" />
              <path
                d="M36.5131 9.71175C36.5919 9.738 36.6721 9.75 36.7501 9.75C37.0644 9.75 37.3568 9.55125 37.4611 9.237C37.4686 9.216 38.1706 7.13925 39.5303 5.78025C39.8236 5.487 39.8236 5.013 39.5303 4.71975C39.2371 4.4265 38.7631 4.4265 38.4698 4.71975C36.8626 6.32625 36.0714 8.664 36.0391 8.763C35.9079 9.156 36.1201 9.5805 36.5131 9.71175Z"
                fill="#FD8F14" />
            </svg>
          </div>
          <div class="content">
            <h5 class="title">Government Subsidies:</h5>
            <p class="disc">
              We help you avail government subsidies and incentives to make solar power even more affordable.
            </p>
            <div class="step_number">
              <span>04</span>
            </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="rts-solution-left-area-left">
          <div class="thumbnail">
            <img src="assets/images/all-black-solar-panel-4.webp" alt="solution" />
          </div>
      ...
      <div class="col-lg-6 pl--90 pl_md--10 pl_sm--10 mt_md--50 mt_sm--30">
        <div class="feed-back-about-wrapper reveal">
          <div class="title-area-left title-g">
            <p class="pre">Our <span> Mission </span></p>
            <h2 class="title skew-up">
              Bringing expertise to every project
            </h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab maxime, obcaecati numquam velit illo
              delectus, laudantium aperiam voluptas dolore facilis sint quas laboriosam fugit voluptates porro
              voluptatum repudiandae, corrupti vitae?</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla harum neque itaque voluptatem libero
              laborum quam soluta.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 pl--90 pl_md--10 pl_sm--10 mt_md--50 mt_sm--30">
        <div class="feed-back-about-wrapper reveal">
          <div class="title-area-left title-g">
            <p class="pre">Our <span> Vission </span></p>
            <h2 class="title skew-up">
              Bringing expertise to every project
            </h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab maxime, obcaecati numquam velit illo
...
<!-- our vission end -->
  ...
  <div class="our-working-process-start rts-section-gap" style="padding-top: 0px">
    <span class="stok-bg images-r"> Work Process </span>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="title-area-center">
            <p class="pre skew-up"><span> Our</span> Working Process</p>
            <h2 class="title skew-up">
              Solar Energy work <br />
              Project Planning
            </h2>
          </div>
        </div>
      ...
      <div class="row g-24 mt--20">
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          ...
          <div class="single-solari-steps-start">
            <div class="thumbnail">
              <img src="assets/images/steps/01.png" alt="steps" />
              <div class="steps">
                <span>01</span>
              </div>
            </div>
            <div class="content">
              <h5 class="title">Choose Location</h5>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          ...
          <div class="single-solari-steps-start">
            <div class="thumbnail">
              <img src="assets/images/steps/02.png" alt="steps" />
              <div class="steps">
                <span>02</span>
              </div>
            </div>
            <div class="content">
              <h5 class="title">Project Planning</h5>
            </div>
          </div>
          <!-- single solari steps area end -->
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          ...
          <div class="single-solari-steps-start">
            <div class="thumbnail">
              <img src="assets/images/steps/03.png" alt="steps" />
              <div class="steps">
                <span>03</span>
              </div>
            </div>
            <div class="content">
              <h5 class="title">Installation & Maintenance</h5>
            </div>
          </div>
          <!-- single solari steps area end -->
        </div>
