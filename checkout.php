  ...
  <div class="row">
    ...
    <main class="ms-main">
      <div class="ms-page-content">
        ...
        <article
          id="post-284"
          class="page checkout-area type-page status-publish hentry"
        >
                  ...
                  <div class="card">
                    <div class="card-header" id="headingOne">
                      <div class="card-title">
                        <span
                          ><i class="fa fa-window-maximize"></i> Have a
                          coupon?</span
                        >
                        <button
                    ...
                    >
                      <div class="card-body">
                        ...
                        <button
                          class="add-btn rts-btn btn-primary"
                          type="submit"
                        >
                          Apply Coupon
                        </button>
              ...
              >
                <div class="row">
                        ...
                        <table>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                Safety Helmet
                                <strong><i class="fa fa-close"></i> 1</strong>
                              </td>
                              <td>$30.00</td>
                            </tr>
                            <tr>
                      ...
                      <div class="payment-method mt-40 md-mt-20">
                        <div class="top-area">
                          ...
                          <div class="p-msg">
                            ...
                            you dont have a PayPal account.
                          </div>
                        </div>
                  ...
                  <div class="pl-lg-5 col-md-4">
                    <h3 id="order_review_heading" class="animated fadeIn">
                      Your order
                    </h3>
                    <div
                      id="order_review"
                    ...
                    >
                          ...
                          <tr class="cart_item">
                            <td colspan="2">
                              <div class="ms-checkout-product">
                                <div class="ms-checkout-product__thumbnail">
                                  <img
                                    src="assets/images/shop/shop-04.jpg"
                                    class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                    alt="Shop Image"
                                  />
                                </div>
                      ...
                      <div id="payment" class="woocommerce-checkout-payment">
                        ...
                        <div class="form-row place-order">
                          ...
                          <div
                            class="ms-proceed-to-checkout wc-proceed-to-checkout"
                          >
                            <a href="#" class="rts-btn btn-primary button">
                              Place Order</a
                            >
                          </div>
                        </div>
